...
const CompanyIndex = () => {
  const QueryCard = [
    ...
    { image:"Taxation.png", heading: "Taxation",para:"We understand the importance of accurate financial records and staying compliant with tax laws, and we take that responsibility very" },
  ];
...
<Box style={{marginTop:"50px",height:"80%",background:"url(Vector12.png)",backgroundSize:"100%",backgroundRepeat:"no-repeat"}}>
